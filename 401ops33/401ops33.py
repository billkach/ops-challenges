...
# Script Name                           401ops33.py
# Author                                Bill Kachersky
# Date of last revision                 11/21/2021
# Description of purpose                Signature-based Malware Detection Part 3 of 3
...
# check VirusTotal Using API Key
def api():
    print("Now, for our final act, let's take one of those hashes and check it against VirusTotal, ")

    apiquery = input("Please enter a valid API key for VirusTotal: ")
    #apikey = os.getenv(apiquery) # test key:
    hash = input("Please enter the hash of the file you'd like to check: ")

    # This concatenates everything into a working shell statement that gets passed into virustotal-search.py
    query = 'python3 virus-totalsearch.py -k ' + apiquery + ' -m ' + hash
...
3 - Query VirusTotal API with file hashes
4 - Exit
